    ...
    return (
      <div className="min-h-screen bg-[#f9fafb] flex flex-col items-center justify-center p-6 text-black">
        ...
        <p className="font-pixelify-sans text-gray-600 text-center max-w-lg mb-8 leading-relaxed">
          ...
          <span className="text-[#004d4d] font-bold">glowing</span> button as fast as you can.
  ...
  if (phase === "warmupPlay") {
    return (
      <div className="min-h-screen bg-[#f9fafb] flex flex-col items-center justify-center p-4 text-black">
        <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-1">Practice — not scored</p>
          ...
          {Array.from({ length: WARMUP_N }, (_, i) => (
            <button
              ...
              className={`transition-all duration-75 border-2 ${
                i === warmupTarget
                  ? "border-[#006666] scale-110 shadow-[0_0_20px_#006666] animate-pulse"
