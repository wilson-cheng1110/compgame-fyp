      ...
      <div className="min-h-screen bg-[#f9fafb] text-black flex flex-col items-center justify-start pt-10 p-6">
        ...
        <div className="w-full max-w-2xl grid md:grid-cols-2 gap-4 mb-8 font-pixelify-sans text-sm text-gray-700">
          <div className="border-2 border-black bg-white p-4">
            <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-2">Rods vs Cones</p>
            Rods see in low light and detect motion at the periphery; cones see colour and fine detail at the centre (fovea).
          </div>
          <div className="border-2 border-black bg-white p-4">
            <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-2">Colour deficiency</p>
  ...
  if (phase === "demos") {
    return (
      <div className="min-h-screen bg-[#f9fafb] text-black flex flex-col items-center justify-start pt-8 p-6">
        <div className="flex gap-2 mb-6 flex-wrap justify-center">
          {DEMOS.map((d, i) => (
            <button
              key={d}
              onClick={() => setDemo(i)}
              className={`font-press-start-2p text-[9px] py-2 px-3 border-2 border-black transition ${i === demo ? "bg-[#006666]" : "bg-white hover:bg-[#f9fafb]"}`}
            >
              {d}
            </button>
          ))}
        ...
        <div className="w-full max-w-2xl bg-white border-2 border-black p-6 mb-6 shadow-[4px_4px_0px_0px_#004d4d] min-h-[280px] flex flex-col items-center">
          {/* Demo 0: Colour vision */}
          {demo === 0 && (
            <>
              <h3 className="font-press-start-2p text-sm text-[#004d4d] mb-4">Status dots — colour only?</h3>
          ...
          {demo === 1 && (
            <>
              <h3 className="font-press-start-2p text-sm text-[#004d4d] mb-4">After-images</h3>
          ...
          {demo === 2 && (
            <>
              <h3 className="font-press-start-2p text-sm text-[#004d4d] mb-4">Depth from 2D cues</h3>
              <div className="relative w-64 h-40 mb-4">
                ...
                <div className="absolute left-24 top-4 w-20 h-20 rounded-full bg-[#006666] border-2 border-black" />
          ...
          {demo === 3 && (
            <>
              <h3 className="font-press-start-2p text-sm text-[#004d4d] mb-4">Reading = jumps, not a glide</h3>
