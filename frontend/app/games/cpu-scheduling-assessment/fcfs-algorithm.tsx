...
export default function FCFSAlgorithm() {
  ...
  const [processes, setProcesses] = useState<Process[]>([
    {
      ...
      arrival: 2,
      burst: 12,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FCFS_A_P1-P3fq7L8U9d84gRYxrx5hxxzTsPdcSZ.png",
    },
    {
      id: "p2",
      name: "P2",
      arrival: 0,
      burst: 3,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FCFS_A_P2-X0IsingRictLKb4pPuKh5dV8kFg8Hb.png",
    },
    {
      id: "p3",
      name: "P3",
      arrival: 1,
      burst: 3,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/FCFS_A_P3-CtsCgAYxjLbwsVDnvrPYSvZLrM3iTo.png",
    },
  ])
  ...
  // Correct answers - updated with new values
  const correctAnswers = {
    p1: { completion: "18", turnaround: "16", waiting: "4", response: "4" },
    p2: { completion: "3", turnaround: "3", waiting: "0", response: "0" },
    p3: { completion: "6", turnaround: "5", waiting: "2", response: "2" },
    avgResponse: "2",
    avgTAT: "8", // Updated from 12 to 8
  }

  // Correct Gantt Chart for FCFS
  const correctGanttChart = [
    { id: "p2", start: 0, end: 3 },
    { id: "p3", start: 3, end: 6 },
    { id: "p1", start: 6, end: 18 },
  ]
  ...
  const handleBackClick = () => {
    console.log("Back button clicked, sending navigation message to parent")
    // Send message to parent window to navigate back to the CPU scheduling assessment menu
      ...
      <div className="relative z-10 min-h-[800px] flex items-start justify-center p-4">
        <div className="border-4 border-[#441dbf] rounded-none bg-[#002b3c] w-full max-w-5xl p-4 min-w-[1000px]">
          ...
          <div className="grid grid-cols-2 gap-4 mb-4">
            {/* Running Box */}
            <div
              className={`bg-black border-2 border-[#441dbf] p-4 h-64 rounded-none relative ${hasSubmitted ? "pointer-events-none" : ""}`}
              onDragOver={(e) => {
            ...
            <div className="grid grid-rows-2 gap-4 h-64">
              {/* Ready Box */}
              <div
                className={`bg-black border-2 border-[#441dbf] p-4 rounded-none relative ${hasSubmitted ? "pointer-events-none" : ""}`}
              >
          ...
          <div className="absolute top-4 left-4">
            <button onClick={handleBackClick} className={`flex items-center font-pixelify-sans ${buttonClass}`}>
