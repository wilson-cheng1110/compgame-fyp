...
export default function SJFAlgorithm() {
  ...
  const [processes, setProcesses] = useState<Process[]>([
    {
      ...
      arrival: 1,
      burst: 3,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SJF_U_P1-JDt9iGYTqdGyVp9p2C7ZCV78xUG8JW.png",
    },
    {
      id: "p2",
      name: "P2",
      arrival: 2,
      burst: 4,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SJF_U_P2-NMXyN8yF4ZFUV4UwM8avtW9Vr0eF37.png",
    },
    {
      id: "p3",
      name: "P3",
      arrival: 1,
      burst: 2,
      imageUrl: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/SJF_U_P3-sHNmaMVLN7kGQK3kqXIw8znrYLtNKU.png",
    },
  ])
  ...
  const handleDropInRunning = () => {
    ...
    // Check if this is the correct process to run next (SJF order)
    ...
    availableProcesses.sort((a, b) => {
      ...
      return (processA?.burst || 0) - (processB?.burst || 0)
    })

    if (draggedProcess !== availableProcesses[0]) {
      setPrompt("Incorrect! Remember, SJF selects the process with the shortest burst time. Try again!")
      if (isSoundOn && failureAudioRef.current) {
        failureAudioRef.current.play().catch((err) => console.error("Error playing sound:", err))
      }
      return
          ...
          <div className="grid grid-cols-4 gap-4 mb-4">
            <div className="col-span-1 bg-[#441dbf] p-4 rounded-none">
              ...
              <p className="font-pixelify-sans text-white text-sm md:text-base">
                Choose the process with the shortest burst time first. If two processes have the same burst time, follow
                their arrival order. Arrange the processes in the correct execution sequence based on SJF scheduling.
              </p>
            </div>
            ...
            <div className="col-span-3 bg-[#002b3c] border-2 border-[#441dbf] p-4 rounded-none">
              <div className="bg-black p-2 mb-4 rounded-none">
                ...
                >
                  {prompt || "Drag the next process that should run according to SJF rules."}
                </p>
              </div>
