      ...
      <div className="min-h-screen bg-[#f9fafb] text-black flex flex-col items-center justify-start pt-10 p-6">
        ...
        <div className="w-full max-w-2xl grid md:grid-cols-3 gap-4 mb-8 font-pixelify-sans text-sm text-gray-700">
          <div className="border-2 border-black bg-white p-4">
            <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-2">Syntax</p>
            Is the sentence well-formed? How do the words structurally fit together?
          </div>
          <div className="border-2 border-black bg-white p-4">
            <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-2">Semantics</p>
            What does it literally mean — independent of who said it or when?
          </div>
          <div className="border-2 border-black bg-white p-4">
            <p className="font-press-start-2p text-[#004d4d] text-[10px] mb-2">Pragmatics</p>
  ...
  if (phase === "play") {
    ...
    return (
      <div className="min-h-screen bg-[#f9fafb] text-black flex flex-col items-center justify-start pt-10 p-6">
        ...
        <div className="bg-white border-2 border-black p-5 mb-6 max-w-xl text-center shadow-[4px_4px_0px_0px_#004d4d]">
        ...
        {picked !== null && (
          <>
            <div className="w-full max-w-xl bg-[#fef9c3] border-2 border-[#006666] p-4 font-pixelify-sans text-sm text-gray-800 leading-relaxed mb-4">
              <p className="font-press-start-2p text-[#004d4d] text-[9px] mb-2">Both readings are valid — {s.level}</p>
              {s.note}
            </div>
            <button
              onClick={next}
